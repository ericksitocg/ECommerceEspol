  ...
  return (
    <BrowserRouter>
      <div className="grid-container">
        <header className="row">
          <div>
            ...
            <Link className="brand" to="/">
              <img class="logo" src="images/Espol.jpg" width="50rem" height="50rem"/>
              ShopESPOL
            </Link>
          </div>
          <div>
            ...
            {userInfo && userInfo.isSeller && (
              <div className="dropdown">
                ...
                <ul className="dropdown-content">
                  ...
                  <li>
                    <Link to="/orderlist/seller">Ordeness</Link>
                  </li>
                </ul>
              </div>
            )}
        ...
        <footer className="row center">Todos los Derechos Reservados -  DAW 2019</footer>
      </div>
    </BrowserRouter>
  );
}
